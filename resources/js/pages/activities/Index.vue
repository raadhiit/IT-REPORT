...
const statusBadgeClass: Record<ActivityStatusValue, string> = {
    ...
    on_track: 'border-transparent bg-amber-100 text-amber-800 dark:bg-amber-950 dark:text-amber-300',
    pending: 'border-transparent bg-rose-100 text-rose-800 dark:bg-rose-950 dark:text-rose-300',
};
